...
import com.medel.market.domain.service.ProductService;
...
public class ProductController {
    ...
    getProduct(@ApiParam(value = "The id of the product", required = true, example = "9") @PathVariable("id") int productId) {
